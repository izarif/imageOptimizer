...
function newobject:initialize()
	...
	input.parent = self
	input:SetSize(input.parent.width - 20, input.parent.height)
	...
	increasebutton:SetPos(increasebutton.parent.width - 21, 0)
	increasebutton:SetHeight(increasebutton.parent.height/2 + 1)
	...
	decreasesbutton:SetPos(decreasesbutton.parent.width - 21, 0)
	decreasesbutton:SetHeight(decreasesbutton.parent.height/2 + 1)
...
function newobject:SetFont(font)
  ...
  local decreasebutton = self.internals[3]
...
function newobject:AutoSize()
  local input = self.internals[1]
  local font = input:GetFont()
  local increasebutton = self.internals[2]
  local decreasebutton = self.internals[3]
  local buttonwidth = font:getHeight() + 7

  self.height = font:getHeight() + 5 * 2
  input:SetSize(self.width - buttonwidth, self.height)
  input:SetPos(self.x, self.y)
  increasebutton:SetSize(buttonwidth, self.height / 2)
  increasebutton:SetPos(self.x + self.width - buttonwidth, self.y)
  decreasebutton:SetSize(buttonwidth, self.height / 2)
  decreasebutton:SetPos(self.x + self.width - buttonwidth, self.y + self.height / 2)
